...
$out=Join-Path $root 'Library/ProductionVerification'
...
& $mono $compiler /nologo /nowarn:0649 "/out:$out/ProductionVerification.exe" "/r:$out/Newtonsoft.Json.dll" "/r:$netstandard" $sources "$PSScriptRoot/ProductionVerification.cs"
if($LASTEXITCODE -ne 0){throw 'Compilation failed'}
& $mono "$out/ProductionVerification.exe" "$root/Assets/StreamingAssets/Data"
