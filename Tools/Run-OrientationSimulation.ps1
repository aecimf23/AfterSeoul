param(
    ...
    [string]$OutputPath = 'Logs/onboarding-orientation-20260915'
)
...
$executable=Join-Path $buildDirectory 'orientation-simulation.exe'
& $mono $compiler /nologo /warn:0 "/out:$executable" "/r:$jsonDll" "/r:$netstandard" @sources "$PSScriptRoot/OrientationSimulation.cs"
