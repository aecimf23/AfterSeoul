...
$executable=Join-Path $buildDirectory 'onboarding.exe'
& $mono $compiler /nologo /warn:0 "/out:$executable" "/r:$jsonDll" "/r:$netstandard" @sources "$PSScriptRoot/OnboardingSimulation.cs"
