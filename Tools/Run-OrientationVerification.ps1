...
$executable=Join-Path $buildDirectory 'orientation.exe'
& $mono $compiler /nologo /warn:0 "/out:$executable" "/r:$jsonDll" "/r:$netstandard" @sources "$PSScriptRoot/OrientationVerification.cs"
